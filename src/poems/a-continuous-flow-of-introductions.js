  ...
  return (
    ...
    >
      ...
      <div className="stanza top-margin">
        ...
        <p className="three-quarters">of it—and then put it off—for a little</p>
        <p>while—</p>
      </div>
      <div className="stanza top-margin">
        <p className="quarter">at the social function—the deathbed—</p>
        <p className="half">a convulsive start made us a hereafter—</p>
        <p className="three-quarters">that unattainable there—sets blinking</p>
        <p>eyes already accustomed—</p>
      </div>
      <div className="stanza top-margin">
      ...
      <div className="stanza top-margin">
        <p className="quarter">
          Well, well, there are no cliffs here, but you don’t mind if I sit down
          beside you, all the same,
        </p>
        <p className="half">
